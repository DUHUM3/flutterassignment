        ...
        ? ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              backgroundColor: btcolor ??
                  AppColor.white, // استبدال `color` بـ `backgroundColor`
              foregroundColor:
                  Colors.white, // استبدال `textColor` بـ `foregroundColor`
              padding: EdgeInsets.zero, // بدلًا من `EdgeInsets.all(0.0)`
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  if (icon != null)
                    Container(child: icon), // شرط أفضل لعرض الأيقونة
                  Center(
                    child: Container(
        ...
        : isCirculer == true
            ...
            : ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor:
                      color ?? AppColor.primaryColorBoxTrance, // لون الخلفية
                  foregroundColor: AppColor.primaryColor, // لون النص
                  padding: EdgeInsets.zero, // لتجنب الحشو المزدوج
                ),
                child: Container(
                  alignment: Alignment.center,
                  width: width,
